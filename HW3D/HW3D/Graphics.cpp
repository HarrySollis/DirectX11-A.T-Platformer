...
Graphics::Graphics(HWND hWnd)
{
	...
	//create device and Buffers/Swap chain and rendering
	...
	//Gain acces to Textures in swap chain(back buffer)
...
void Graphics::DrawTriangle(float angle, float x, float z)
{
	...
	{
		{
			dx::XMMatrixTranspose(
				...
				dx::XMMatrixTranslation(x, 0.0f,z + 6.0f) *
	...
	//Primitive topology for triangle list
